...
// 
router.get('/getvitalsitedata', (req, res) => {
  // SELECT * FROM hospital7.master_flowsheetvitalheader group by flowsheetheader;
  // const command = `SELECT * FROM master_headervitals`;
...
router.get('/getcuffsize', (req, res) => {
  // SELECT * FROM hospital7.master_flowsheetvitalheader group by flowsheetheader;
  // const command = `SELECT * FROM master_headervitals`;
...
router.get('/gettempraturedevice', (req, res) => {
  // SELECT * FROM hospital7.master_flowsheetvitalheader group by flowsheetheader;
  // const command = `SELECT * FROM master_headervitals`;
...
router.get('/getConsciousness', (req, res) => {
;
  const command = `SELECT * FROM master_consciousness; `;
  console.log(command);
  execCommand(command)
    .then(result => res.json(result))
    .catch(err => logWriter(command, err));
...
router.post('/Labsflowsheetsave', (req, res) => {
  ...
  const commands = `DELETE FROM master_labsflowsheet where patient_id='${patientid}'`;
  console.log(commands);
  execCommand(commands)
    .then(result => {
      if (result) {
        ...
        (function loop() {
          if (i < flowsheetdatass.length) {
            ...
            const command = `INSERT INTO master_labsflowsheet(ids, patient_id, value) VALUES ('${flowsheetdatass[i].ids}', '${patientid}', '${flowsheetdatass[i].value}')`;
            console.log(command);
...
router.post('/LabsflowsheetCheckBoxsave', (req, res) => {
  // console.log('LabsflowsheetCheckBoxsave',req.body);
  var patientid = req.body.patientguid;
  var flowsheetdatas = req.body.flowsheetvital;

  const commands = `delete from master_labsflowsheetcheckbox where patient_id='${patientid}'`;
  console.log(commands);
  execCommand(commands)
    .then(result => {
      if (result) {
        ...
        (function loop() {
          if (i < flowsheetdatas.length) {
            const command = `INSERT INTO  master_labsflowsheetcheckbox( patient_id,ids, headernames) values('${patientid}','${flowsheetdatas[i].ids}','${flowsheetdatas[i].headernames}')`;
            console.log(command);
            execCommand(command)
              .then(() => {
                i++;
...
router.post('/savelabsflowsheetColumData', (req, res) => {
  ...
  console.log(req.body);
  var flowsheetdatas = req.body.cols;
  const commands = `delete from master_labsflowsheettime where Patient_Id='${patientid}'`;
  execCommand(commands)
    .then(result => {
      if (result) {
        let i = 0;
...
router.post('/labsflowsheetCheckBoxsaveget', (req, res) => {
  var patientid = req.body.patientguid;
  const command = `SELECT * FROM master_labsflowsheetcheckbox where patient_id='${patientid}';`;
  console.log(command);
  execCommand(command)
    .then(result => res.json(result))
    .catch(err => logWriter(command, err));
...
router.post('/getlabsflowsheetcolumdata', (req, res) => {
  var patientguid = req.body.patientguid
  const command = `SELECT * FROM master_labsflowsheettime where Patient_Id='${patientguid}'`;
  console.log(command);
  execCommand(command)
    .then(result => res.json(result))
    .catch(err => logWriter(command, err));
...
router.post('/getlabsflowsheetcontaindata', (req, res) => {
  ...
  const command = `SELECT * FROM master_labsflowsheet where patient_id='${patientguid}'`;
  console.log(command);
  execCommand(command)
