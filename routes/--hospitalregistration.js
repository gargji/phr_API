...
router.post('/Hospital_Registration', (req,res)=>{
    ...
    command = `INSERT INTO transaction_organization(guid,organization_name,addressLine1,addressLine2,City,district_name,states_name,Country,countrycode,Land_Mark,Postal_Code,displayname) 
