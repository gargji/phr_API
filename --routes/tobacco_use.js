...
AnyCurrentPassiveExposure_toE_Cigarette=req.body.data.AnyCurrentPassiveExposure_toE_Cigarette
    ...
    if(id=='' || id=='0' || id==undefined || id==null){
        command = `INSERT INTO transaction_tobacco_use(patientId,branchId,hospital_Id,Tobacco_use_Status,Smoking_Status,Source,SmokedTobaccoStartDate,SmokedTobaccoQuitDate,SmokelessTobaccoStartDate,SmokelessTobaccoQuitDate,Electronic_Cigarette_VapingStartDate,Electronic_Cigarette_VapingQuitDate,type,PackPerDays,Year,PackYears,SmokedTobacco_Counselling,ElectronicCigarette_VapingCounseling,SmokedTobacco_Notes,Electronic_Cigarette_VapingNotes,SmokelessTobaccoType,SmokelessTobaccoStatus,Last30day_status,E_LiquidContainsNicotine,E_LiquidContainsCannabis,NumberofUnitsPerDay,DisposableE_Cigarette,PrefilledCartridge_Cigarette,RefillableTankE_Cigarette,HeatNotBurnTobacco_Device,AnyCurrentPassiveExposure_toE_Cigarette,tranasaction_time) values
        ('${patientId}','${branchId}','${hospital_Id}','${Tobacco_use_Status}','${Smoking_Status}','${Source}','${SmokedTobaccoStartDate}','${SmokedTobaccoQuitDate}','${SmokelessTobaccoStartDate}','${SmokelessTobaccoQuitDate}','${Electronic_Cigarette_VapingStartDate}','${Electronic_Cigarette_VapingQuitDate}','${type}','${PackPerDays}','${Year}','${PackYears}','${SmokedTobacco_Counselling}','${ElectronicCigarette_VapingCounseling}','${SmokedTobacco_Notes}','${Electronic_Cigarette_VapingNotes}','${SmokelessTobaccoType}','${SmokelessTobaccoStatus}','${Last30day_status}','${E_LiquidContainsNicotine}','${E_LiquidContainsCannabis}','${NumberofUnitsPerDay}','${DisposableE_Cigarette}','${PrefilledCartridge_Cigarette}','${RefillableTankE_Cigarette}','${HeatNotBurnTobacco_Device}','${AnyCurrentPassiveExposure_toE_Cigarette}', now())`;
    }
    else{
         command = `update transaction_tobacco_use set Tobacco_use_Status='${Tobacco_use_Status}',Smoking_Status='${Smoking_Status}',Source='${Source}',SmokedTobaccoStartDate='${SmokedTobaccoStartDate}',SmokedTobaccoQuitDate='${SmokedTobaccoQuitDate}',SmokelessTobaccoStartDate='${SmokelessTobaccoStartDate}',SmokelessTobaccoQuitDate='${SmokelessTobaccoQuitDate}',Electronic_Cigarette_VapingStartDate='${Electronic_Cigarette_VapingStartDate}',SmokelessTobaccoStatus='${SmokelessTobaccoStatus}',Electronic_Cigarette_VapingQuitDate='${Electronic_Cigarette_VapingQuitDate}',type='${type}',PackPerDays='${PackPerDays}',Year='${Year}',PackYears='${PackYears}',SmokedTobacco_Counselling='${SmokedTobacco_Counselling}',ElectronicCigarette_VapingCounseling='${ElectronicCigarette_VapingCounseling}',SmokedTobacco_Notes='${SmokedTobacco_Notes}',Electronic_Cigarette_VapingNotes='${Electronic_Cigarette_VapingNotes}',SmokelessTobaccoType='${SmokelessTobaccoType}',Last30day_status='${Last30day_status}',E_LiquidContainsNicotine='${E_LiquidContainsNicotine}',E_LiquidContainsCannabis='${E_LiquidContainsCannabis}',NumberofUnitsPerDay='${NumberofUnitsPerDay}',DisposableE_Cigarette='${DisposableE_Cigarette}',PrefilledCartridge_Cigarette='${PrefilledCartridge_Cigarette}',RefillableTankE_Cigarette='${RefillableTankE_Cigarette}',HeatNotBurnTobacco_Device='${HeatNotBurnTobacco_Device}',AnyCurrentPassiveExposure_toE_Cigarette='${AnyCurrentPassiveExposure_toE_Cigarette}',tranasaction_time=now() where id='${id}'`;
        returnmessage="U"
    }
...
router.post('/getTransactionTobaccoUse', (req,res)=>{
    ...
    const command = `Select *,(select name from master_smokeless_tobocoo_status where id=transaction_tobacco_use.SmokelessTobaccoStatus) as SmokelessTobaccoStatusName,(select name from master_smoking_status where id=transaction_tobacco_use.Smoking_Status) as smokingStatusName,(select name from master_smoking_type where id=transaction_tobacco_use.type) as Smokingtypes  from transaction_tobacco_use where patientId='${Patientguid}'`;
...
router.get('/Getmaster_smokeless_tobocoo_status', (req,res)=>{
    ...
    const command = `Select * from master_smokeless_tobocoo_status`;
...
router.get('/GetMaster_smokeless_tobacco_type', (req,res)=>{
    ...
    const command = `Select * from master_smokeless_tobacco_type`;
...
router.get('/Getmaster_smoking_types', (req,res)=>{
    ...
    const command = `Select * from master_smoking_type`;
